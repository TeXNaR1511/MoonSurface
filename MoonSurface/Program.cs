...
namespace MoonSurface
{
    class Program : GameWindow
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            terrain = new Terrain(new FileInfo("./Resources/heightmap.png"));//сама картинка
            camera = new Camera(new Vector3(0, 50/*terrain.getHeightAtPosition(256, 256)*/, 0), Width / (float)Height);//положение камеры начальное
